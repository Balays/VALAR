...
if (load.prev) {
  ...
  orf.sum.perc  <- fread( paste0(fig.dir, '/', norm.method, '_', EndType, '_counts.norm.tsv') )
...
samples_to_filt <- c('C6_2h_3', 'PC-12_8h_3', 'C6_0.5h_1', 'C6_0.5h_2', 'PC-12_0.5h_3', 'PK-15_2h3',
