...
reference=/mnt/d/data/genomes/LT934125.1.fasta
contig=LT934125.1
...
filt_out_sam=${main_dir}/rebasecall/mapped_v6_virus/filtered_sam/PK-15
outdir=${main_dir}/rebasecall/mapped_v6_virus/LoRTIA_virus/PK-15
