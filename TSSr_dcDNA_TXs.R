...
TSSr_clusters_uni <- fread(paste0(outdir, '/TSSr.dcDNA.uni.Cluster.Results.txt'))
...
#### Write out
fwrite(TR.Ref.data.dcDNA,        paste0(outdir, '/TR.Ref.data.dcDNA.tsv'),        sep = '\t')
fwrite(TR.gff.compare.uni.dcDNA, paste0(outdir, '/TR.gff.compare.uni.dcDNA.tsv'), sep = '\t')
fwrite(dcDNA.support.freq,       paste0(outdir, '/dcDNA.support.freq.tsv'),       sep = '\t')
fwrite(TSSr_clusters_uni,        paste0(outdir, '/dcDNA.TSSr_clusters_uni.tsv'),  sep = '\t')
...
TSSr_clusters_uni        <- fread(paste0(outdir, '/dcDNA.TSSr_clusters_uni.tsv'),  na.strings = '')
