...
TR.gff.compare.uni <- merge(dcDNA.TES.TF.OV[,.(seqnames, strand, TC.start=start, TC.end=end, dcDNA_TC_ID=gene, support, score, consensus_peak, transcript_id)],
...
TR.gff.compare.uni[!is.na(dcDNA_TC_ID) & consensus_peak == prime3 & class_code == '=', .N]
...
length(unique(TR.gff.compare.uni[class_code == '=' & !is.na(dcDNA_TC_ID) & consensus_peak == prime3, cmp_ref]))
...
TR.merged.data <- merge(TR.merged.data,
                        ...
                        dcDNA.TES.REF.OV[,.(seqnames, strand, TC.start=start, TC.end=end, dcDNA_TC_ID=gene, support, score, consensus_peak, transcript_id, exon_number)],
