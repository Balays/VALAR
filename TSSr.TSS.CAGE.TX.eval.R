...
TR.gff.compare.merged.TR.counts.gt <- fread(paste0(config$outdir, "/TR.gff.compare.merged.TR.counts.gt.tsv.gz"), na.strings = '')


### TSSr Results from dcDNA reads (combined clusters)
TSSr_clusters_uni <- fread(paste0(CAGE_config$outdir, '/TSSr.TSS.CAGE.uni.Cluster.Results.txt'))
